<xsl:stylesheet
  ...
  <xsl:param name="chNFeCons"/>
  
  <xsl:param name="nomeEmitente"/>
  <xsl:param name="nomeDestinatario"/>

  <xsl:include href="Utils.xsl"/>
  <xsl:include href="_Estilos_Geral.xsl"/>
  <xsl:include href="_Scripts_Geral.xsl"/>

  <xsl:template match="/" name="retConsDPEC">
    ...
    <div id="DPEC" style="width: 800px">
        ...
        <table>
          <tr>
            <td width="150">
              ...
              <span>
                <xsl:variable name="tpAmb" select="//n:tpAmb"/>
      ...
      <xsl:if test="//n:retDPEC/n:infDPECReg/n:cStat">
        <fieldset>
          ...
          <table>
            <tr>
              <td colspan="3">
                ...
                <span>
                  <xsl:value-of select="//n:retDPEC/n:infDPECReg/n:cStat"/> - <xsl:value-of select="//n:retDPEC/n:infDPECReg/n:xMotivo"/>
                </span>
              </td>
            </tr>
            <tr>
              <td>
                ...
                <span>
                  <xsl:call-template name="formatDateTime">
                    <xsl:with-param name="dateTime" select="//n:retDPEC/n:infDPECReg/n:dhRegDPEC"/>
              ...
              <td>
                ...
                <span>
                  <xsl:value-of select="//n:retDPEC/n:infDPECReg/n:nRegDPEC"/>
                </span>
              </td>
              <td>
                <label>Versão AN</label>
                <span>
                  <xsl:value-of select="//n:retDPEC/n:infDPECReg/n:verAplic"/>
                </span>
              </td>
            </tr>
        ...
        <xsl:for-each select="//n:retDPEC/n:infDPECReg/n:envDPEC/n:infDPEC/n:resNFe">
          
          <xsl:variable name="chNFe" select="n:chNFe"/>
          
          <xsl:if test="$chNFe=$chNFeCons">
            ...
            <fieldset>
              ...
              <table>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <span>
                      <xsl:call-template name="nomeMes">
                        <xsl:with-param name="mes" select="substring($chNFe,5,2)"/>
                      </xsl:call-template>                      
                      <xsl:value-of select="concat('/',substring($chNFe,3,2))"/>
                    </span>
                  </td>
                  <td>
                  ...
                  <td>
                    <label>Versão Empresa</label>
                    <span>
                      <xsl:value-of select="//n:retDPEC/n:infDPECReg/n:envDPEC/n:infDPEC/n:ideDec/n:verProc"/>
                    </span>
                  </td>                  
                </tr>
              </table>
                  ...
                  <td width="150">
                    ...
                    <span>
                      <xsl:call-template name="formatCnpj">
                        <xsl:with-param name="cnpj" select="//n:retDPEC/n:infDPECReg/n:envDPEC/n:infDPEC/n:ideDec/n:CNPJ"/>
                      </xsl:call-template>
                    </span>
                  </td>
                  <td>
                    ...
                    <span>
                      <xsl:value-of select="$nomeEmitente"/> &#160;
                    </span>
                  </td>
                  <td width="150">
                    <label>Inscrição Estadual</label>
                    <span>
                      <xsl:value-of select="//n:retDPEC/n:infDPECReg/n:envDPEC/n:infDPEC/n:ideDec/n:IE"/>
                    </span>
                  </td>                  
                  <td width="80">
                    <label>UF</label>
                    <span>
                      <xsl:value-of select="//n:retDPEC/n:infDPECReg/n:envDPEC/n:infDPEC/n:ideDec/n:cUF"/> - <xsl:call-template name="siglaUF">
                        <xsl:with-param name="uf" select="//n:retDPEC/n:infDPECReg/n:envDPEC/n:infDPEC/n:ideDec/n:cUF"/>
                      </xsl:call-template>
                    </span>
                  </td>
                </tr>
            ...
            <fieldset>
              ...
              <xsl:variable name="cnpj" select="n:CNPJ"/>
                ...
                <table>
                  <tr>
                    ...
                    <td>
                      <label>Nome / Razão Social</label>
                      <span>
                        <xsl:value-of select="$nomeDestinatario"/> &#160;
                      </span>
                    </td>                   
                    <td width="80">
                      <label>UF</label>
