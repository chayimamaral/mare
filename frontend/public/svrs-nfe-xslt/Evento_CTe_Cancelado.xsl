...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/" name="Evento_CTe_Cancelado">

    <xsl:variable name="prot" select="n:retEvento/n:infEvento/n:nProt" />
    <div id="EventoCTeCancelado{$prot}" class="GeralXslt">
      <fieldset>
        <legend class="titulo-aba">CT-e Cancelado</legend>
        <table class="box">
          <tr>
      ...
      <fieldset>
        ...
        <table class="box">
          <tr class="col-2">
            ...
            <td colspan="2">
              <label>Protocolo de Cancelamento CT-e</label>
              <span>
                <xsl:value-of select="n:evento/n:infEvento/n:detEvento/n:CTe/n:nProtCanc"/>
              </span>
            </td>
          </tr>              
        </table> 
