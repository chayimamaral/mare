...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/" name="Evento_Cancelamento">
      <xsl:if test="n:evento/n:infEvento/n:tpEvento=110111">

        <xsl:variable name="prot" select="n:retEvento/n:infEvento/n:nProt" />
        <div id="EventoCanc" class="GeralXslt">
            <fieldset>
              ...
              <table class="box">
                <tr class="col-2">
                  <td colspan="2">
                    ...
                    <span>
                      <xsl:value-of select="n:evento/n:infEvento/n:tpEvento"/> - Cancelamento pelo Emitente
                    </span>
                  </td>
                  <td colspan="2">
