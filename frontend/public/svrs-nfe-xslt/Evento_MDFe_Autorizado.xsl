...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/" name="Evento_MDFe_Autorizado">

    <xsl:variable name="prot" select="n:retEvento/n:infEvento/n:nProt" />
    <div id="EventoMDFeAutorizado{$prot}" class="GeralXslt">
      <fieldset>
        <legend class="titulo-aba">MDF-e Autorizado</legend>
        <table class="box">
          <tr>
        ...
        <table class="box">
          <tr class="col-2">
            ...
            <td colspan="2">
              ...
              <span>
                <xsl:value-of select="n:evento/n:infEvento/n:detEvento/n:MDFe/n:chCTe"/>
              </span>
            </td>
          </tr>
          <tr class="col-2">
            <td colspan="2">
              <label>Data de emissão do MDF-e</label>
              <span>

                <xsl:call-template name="formatDateTimeFuso">
                  <xsl:with-param name="dateTime" select="n:evento/n:infEvento/n:detEvento/n:MDFe/n:dhEmi"/>
                  <xsl:with-param name="include_as" select="1"/>
                </xsl:call-template>
              </span>
            </td>
            <td colspan="2">
              <label>Data da autorização do MDF-e</label>
              <span>
                <xsl:call-template name="formatDateTimeFuso">
                  <xsl:with-param name="dateTime" select="n:evento/n:infEvento/n:detEvento/n:MDFe/n:dhRecbto"/>
                  <xsl:with-param name="include_as" select="1"/>
                </xsl:call-template>
              </span>
            </td>
          ...
          <tr class="col-2">
            <td colspan="2">
              <label>Modal</label>
              <span>
                <xsl:variable name="modalidade" select="n:evento/n:infEvento/n:detEvento/n:MDFe/n:modal"/>
                <xsl:choose>
            ...
            <td colspan="2">
              <label>Número Protocolo Autorização MDF-e</label>
              <span>
                <xsl:value-of select="n:evento/n:infEvento/n:detEvento/n:MDFe/n:nProt"/>
              </span>
            </td>
          </tr>
        </table>
